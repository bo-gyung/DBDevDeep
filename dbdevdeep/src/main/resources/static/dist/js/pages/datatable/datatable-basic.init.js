...
$('#my-alert').DataTable({
	...
	"initComplete": function() {
		...
		searchButton.on('click', function() {
			var searchTerm = searchInput.val();  // 검색어 가져오기
			$('#my-alert').DataTable().search(searchTerm).draw();  // 검색어로 필터링
		});
...
$('#employee-attend').DataTable({
	...
	"initComplete": function() {
		...
		searchButton.on('click', function() {
			var searchTerm = searchInput.val();  // 검색어 가져오기
			$('#employee-attend').DataTable().search(searchTerm).draw();  // 검색어로 필터링
		});
...
// 보고서 임시 테이블 
$('#approveDraftDocu_config').DataTable({
...
$('#student_list').DataTable({
	...
	"initComplete": function() {
		...
		searchButton.on('click', function() {
			var searchTerm = searchInput.val();  // 검색어 가져오기
			$('#student_list').DataTable().search(searchTerm).draw();  // 검색어로 필터링
		});
...
$('#student_emp_list').DataTable({
	...
	"initComplete": function() {
		...
		searchButton.on('click', function() {
			var searchTerm = searchInput.val();  // 검색어 가져오기
			$('#student_emp_list').DataTable().search(searchTerm).draw();  // 검색어로 필터링
		});
...
$('#home_student_list').DataTable({
	...
	"initComplete": function() {
		...
		searchButton.on('click', function() {
			var searchTerm = searchInput.val();  // 검색어 가져오기
			$('#home_student_list').DataTable().search(searchTerm).draw();  // 검색어로 필터링
		});
...
$('#subject_list').DataTable({
	...
	"initComplete": function() {
		...
		searchButton.on('click', function() {
			var searchTerm = searchInput.val();  // 검색어 가져오기
			$('#subject_list').DataTable().search(searchTerm).draw();  // 검색어로 필터링
		});
