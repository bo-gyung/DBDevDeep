    ...
    window.connectWebSocket = function() {
		...
		socket.onmessage = function(event) {
		    ...
		    if (message.alert) {
		        ...
		        const alertHtml = `
		        	<a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2 " style="cursor: auto;">
			        	<div data-alert-no="${alert.alarm_no}"
		        			...
		        			class="message-item d-flex align-items-center">
			            ...
			            <div class="w-25 d-inline-block v-middle text-center" style="color: lightgray;"
